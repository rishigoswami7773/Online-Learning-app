...
class _StudentDashboardState extends State<StudentDashboard>
  ...
  Widget _buildCourseGrid(
    List<LegacyCourseModel> courses, {
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return CourseCard(data: course.toMap(), key: ValueKey(course.id));
      },
    );
  }

  Widget _buildTrending(List<LegacyCourseModel> courses) {
    if (courses.isEmpty) {
      return Padding(
        padding: const EdgeInsets.all(DashboardConstants.spacingL),
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, index) {
          ...
          return SizedBox(
            width: 160,
            child: CourseCard(data: course.toMap(), key: ValueKey(course.id)),
          );
        },
      ),
    );
  ...
  List<LegacyCourseModel> _filteredCourses(List<LegacyCourseModel> source) {
