...
class _CoursesPageState extends State<CoursesPage> {
  ...
  late Future<List<LegacyCourseModel>> _courseFuture;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: FutureBuilder<List<LegacyCourseModel>>(
      ...
      bottomNavigationBar: NavigationBar(
        ...
        onDestinationSelected: (index) {
          try {
            ...
            if (index == 2) {
              GoRouter.of(context).go(AppRoutes.studentMyCourses);
              return;
            }
            if (index == 3) {
  ...
  List<LegacyCourseModel> _applyFilters(List<LegacyCourseModel> source) {
...
class _CourseCard extends StatelessWidget {
  ...
  final LegacyCourseModel course;
