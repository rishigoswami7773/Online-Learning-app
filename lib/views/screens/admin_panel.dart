...
class AdminPanel extends StatelessWidget {
  ...
  Future<void> _logout(BuildContext context) async {
    ...
    // Use go to replace navigation stack so back button cannot return to protected screens
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () =>
                    GoRouter.of(context).go(AppRoutes.manageCourses),
                icon: const Icon(Icons.list),
                label: const Text('Manage Courses'),
              ),
              const SizedBox(height: 8),
              ElevatedButton.icon(
                onPressed: () => GoRouter.of(context).go(AppRoutes.manageUsers),
