...
class AdminActionCard extends StatelessWidget {
  ...
  const AdminActionCard({super.key, required this.title, required this.icon});
...
class AdminActivityCard extends StatelessWidget {
  ...
  const AdminActivityCard({super.key, required this.title, required this.time});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [BoxShadow(color: Theme.of(context).colorScheme.outlineVariant.withValues(alpha: 0.5), blurRadius: 6)],
      ),
      child: ListTile(
        leading: Icon(Icons.notifications, color: AdminDashboard.primaryColor),
        title: Text(title),
        subtitle: Text(time),
      ),
    );
