...
class LegacyCourseCard extends StatelessWidget {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (showProgress && normalizedProgress != null) ...[
                        const SizedBox(height: DashboardConstants.spacingM),
                        // Some callers still hand in percent-like values; clamp to a real fraction.
                        ClipRRect(
                        ...
                        const SizedBox(height: DashboardConstants.spacingS),
                        Text(
                          '${(normalizedProgress * 100).toStringAsFixed(0)}% completed',
                          style: Theme.of(context).textTheme.bodySmall
                              ?.copyWith(
                                color: DashboardConstants.brandColor,
                                fontWeight: FontWeight.w600,
