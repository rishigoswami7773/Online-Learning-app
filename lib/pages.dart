...
// Student screens
export 'views/screens/student/student_dashboard.dart';
...
export 'views/screens/student/checkout_screen.dart';
export 'views/screens/student/student_quiz_screen.dart';
export 'views/screens/student/student_assignment_screen.dart';
...
export 'views/screens/mentor/mentor_quiz_screen.dart';
export 'views/screens/mentor/mentor_lessons_screen.dart';
export 'views/screens/mentor/mentor_create_course_new.dart';
export 'views/screens/mentor/mentor_student_progress.dart';
...
export 'views/screens/admin/admin_user_approvals_screen.dart';
export 'views/screens/admin/admin_mentor_invites_screen.dart';
...
export 'views/screens/admin/admin_mentor_panel_screen.dart';
export 'views/screens/manage_users_screen.dart';
// hide AdminAnalyticsScreen because admin_analytics_screen.dart already exports it
export 'views/screens/admin/manage_categories.dart';
// REMOVED analytics.dart — it caused ambiguous export of AdminAnalyticsScreen
export 'views/screens/admin/manage_reviews.dart';
export 'views/screens/admin/admin_modules_screen.dart';
export 'views/screens/admin/admin_quizzes_screen.dart';
export 'views/screens/admin/admin_enrollments_screen.dart';
...
export 'views/auth/login_page.dart';
export 'views/profile/edit_profile_page.dart';
